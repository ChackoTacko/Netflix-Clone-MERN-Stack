...
const SVGComponent = (props) => (
  <svg width={96} height={96} fill="none" {...props}>
    ...
    <defs>
      ...
      >
        <stop offset={0.286} stopColor="#7D2889" />
        <stop offset={0.724} stopColor="#FF66D9" stopOpacity={0.41} />
      ...
      >
        ...
        <stop offset={0.453} stopColor="#FF66D9" stopOpacity={0.36} />
        <stop offset={1} stopColor="#fff" stopOpacity={0} />
      </radialGradient>
      <radialGradient
        id="c"
      ...
      >
        <stop offset={0.432} stopColor="#FF8B54" />
        <stop offset={0.76} stopColor="#FFBB8D" />
      ...
      >
        <stop offset={0.302} stopColor="#F9DDD1" />
        <stop offset={0.674} stopColor="#FFBB8D" />
      ...
      >
        <stop offset={0.375} stopColor="#FFF4EB" />
      ...
      >
        <stop offset={0.375} stopColor="#F9DDD1" />
        <stop offset={1} stopColor="#FFF3EB" stopOpacity={0} />
      </radialGradient>
      <radialGradient
        id="x"
      ...
      >
        ...
        <stop offset={0.431} stopColor="#FFF1F1" />
      ...
      >
        ...
        <stop offset={0.5} stopColor="#CE3A00" />

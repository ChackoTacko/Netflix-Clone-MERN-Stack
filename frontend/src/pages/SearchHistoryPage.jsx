      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {searchHistory?.map((entry, index) => (
            <div key={index} className="bg-gray-800 rounded flex p-4 items-center">
              ...
              <span className={`py-1 px-3 min-w-20 text-center rounded-ful text-sm ml-auto ${entry.searchType === "movie" ? "bg-red-600" : entry.searchType === "tv" ? "bg-blue-600" : "bg-green-600"}`}>{entry.searchType[0].toUpperCase() + entry.searchType.slice(1)}</span>
